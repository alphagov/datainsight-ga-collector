...
describe "Hourly Collector Module" do
  ...
  it "should create a range for yesterday" do
    on_tuesday = HourlyDummy.last_before(Date.new(2012, 8, 9))

    on_tuesday.start_at.should eql(Date.new(2012, 8, 8))
    on_tuesday.end_at.should eql(Date.new(2012, 8, 9))
  end

  it "should create one day ranges between 2012-08-08 and 2012-08-09" do
    on_tuesday = HourlyDummy.all_within(Date.new(2012, 8, 8), Date.new(2012, 8, 9))
  ...
  it "should create four day ranges between 2012-08-08 and 2012-08-13" do
    four_days = HourlyDummy.all_within(Date.new(2012, 8, 8), Date.new(2012, 8, 12))
  ...
  it "should create no day ranges between 2012-08-08 and 2012-08-08" do
    no_days = HourlyDummy.all_within(Date.new(2012, 8, 8), Date.new(2012, 8, 8))

    no_days.should be_a(Array)
    no_days.should be_empty
  end
end