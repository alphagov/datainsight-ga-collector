...
describe "Inside Gov Weekly Visitors Config" do

  before(:all) do
    @configs = GoogleAnalytics::Config::InsideGovWeeklyVisitors.last_before(Date.new(2012, 8, 13))
  end

  it "should have an amqp_topic of google_analytics.inside_gov.visitors.weekly" do
    @configs.amqp_topic.should == 'google_analytics.inside_gov.visitors.weekly'
  end
